...
fetch(`${process.env.REACT_APP_API_BASE_URL}/connection.php`,{method:'post',header:{'Content-Type':'application/json'},body:JSON.stringify(clie)})
...
fetch(`${process.env.REACT_APP_API_BASE_URL}/form_fields.php`)
...
fetch(`${process.env.REACT_APP_API_BASE_URL}/projects.php?project_access=${cookies.all.project_access}`)
...
fetch(`${process.env.REACT_APP_API_BASE_URL}/fb/submit_campaign.php`,{
  method:'post',
