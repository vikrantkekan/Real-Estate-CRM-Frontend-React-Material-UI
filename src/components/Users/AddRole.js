...
function AddRole(){
 ...
 const [cookies, setCookie,removeCookie] = useCookies(['name','all']);
  ...
  fetch(`${process.env.REACT_APP_API_BASE_URL}/add_role.php?clie=${cookies.all.clie}`,{method:'post',header:{'Content-type':'application/json'},body:JSON.stringify(body_data)})
