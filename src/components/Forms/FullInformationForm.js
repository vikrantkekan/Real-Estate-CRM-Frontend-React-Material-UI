...
fetch(`${process.env.REACT_APP_API_BASE_URL}/update_lead.php`,{
  method:"post",
...
<FormControl sx={{p:1}}>
<TextField placeholder="Project" label="Project" size="small" defaultValue={dat.project_name} ></TextField>
</FormControl>

<FormControl sx={{p:1}}>
<TextField placeholder="Platform" label="Platform" defaultValue={dat.platform} size="small" ></TextField>
</FormControl>

<FormControl sx={{p:1}}>
<TextField placeholder="Campaign" label="Campaign" defaultValue={dat.camp_name} size="small" ></TextField>
</FormControl>

<FormControl sx={{p:1}}>
<TextField placeholder="On Date" label="On Date" size="small" defaultValue={dat.on_date}></TextField>
</FormControl>

<FormControl sx={{p:1}}>
<TextField placeholder="Status" label="Status" size="small" defaultValue={dat.statu}></TextField>
</FormControl>

<FormControl sx={{p:1}}>
<TextField placeholder="Last Followup Date" label="Last Followup Date" size="small" defaultValue={dat.last_foll_date}></TextField>
</FormControl>
