...
import AddWebsite from '../Connect/AddWebsite';
...
fetch(`${process.env.REACT_APP_API_BASE_URL}/email_template_list.php?clie=${cookies.all.clie}`)
...
<span style={{float:'left',margin:'25px',marginTop:'35px',fontSize:'18px',fontWeight:600}}>Email Templates</span>

<Button variant="outlined" startIcon={<AddIcon />} sx={{float:'right',m:3}} onClick={handle_add_modal} disabled>
Add New Template
</Button>
...
<TableCell align="left" sx={{backgroundColor:'#f4f6f8', color:'#637381'}}>Template Name</TableCell>
<TableCell align="left" sx={{backgroundColor:'#f4f6f8', color:'#637381'}}>Email Subject</TableCell>
<TableCell align="left" sx={{backgroundColor:'#f4f6f8', color:'#637381'}}>Email Body</TableCell>
