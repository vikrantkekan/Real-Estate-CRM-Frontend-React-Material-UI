...
fetch(`${process.env.REACT_APP_API_BASE_URL}/layout_frame.php`,{method:'post',header:{'Content-Type':'application/json'},body:pid2}).then((response)=>response.json()).then((data)=>{
    console.log(data)
    setConfi(data);
